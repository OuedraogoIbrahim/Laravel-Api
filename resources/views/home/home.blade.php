    ...
    @if (isset($nothing))
        ...
        <div class="big-container">
            ...
            <div class="form">
                ...
                <form action="{{ route('competition') }}" method="get">
                    <input type="search" id="search-input" name="competition"
                        placeholder="Nom de la competition recherché" required autocomplete="off">
        ...
        @else
            ...
            <div class="big-container">
                ...
                <div class="form">
                    <form action="{{ route('team') }}" method="get">
                        <input type="search" id="search-team-input" name="team"
                            placeholder="Nom de l'equipe recherché" required autocomplete="off">
                        <ul id="suggestions-team-list"></ul>
                        <button>Rechercher</button>
                ...
                <span class="live"><a href="{{ route('live.match') }}">Matchs
                        en direct</a></span>
                                    ...
                                    <div class="time">
                                        ...
                                        @if (
                                            ...
                                            <a class="match-played"
                                                id="{{ 'match-played' . $league[$i]['event_key'] }}"
                                                href="{{ route('match.details', ['home' => $league[$i]['event_home_team'], 'away' => $league[$i]['event_away_team'], 'date' => $league[$i]['event_date'], 'key' => $league[$i]['event_key'], 'home_team' => $league[$i]['home_team_key'], 'away_team' => $league[$i]['away_team_key']]) }}">
                                                {{ $score_actuel }} </a>
